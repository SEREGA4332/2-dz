...
def acounting(file:str) -> int:
    return sum(1 for _ in open('Home.py', 'rt', encoding='utf-8'))
...
ile_for_writing = os.path.abspath('\\Users\\SEREGA\\Desktop\\Top dz\\Home.py')
base_path = os.getcwd()
location = os.path.abspath('\\Users\\SEREGA\\Desktop\\Top dz')
